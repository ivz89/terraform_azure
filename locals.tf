locals {
  ...
  ComponentServersLinux = {
    ...
    "FortiGate-01" = { vmsize = "Standard_D2_v4", os = local.os.oracle,  identity = "SystemAssigned", ip_subnets = [
        { name = "External", ip = "10.0.2.1", subnet = module.network_core.subnet_ids["FortiGateExternal"] },
        { name = "Internal", ip = "10.0.3.1", subnet = module.network_core.subnet_ids["FortiGateInternal"] }
      ]}
